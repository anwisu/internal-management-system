...
function Modal({ open, onClose, title, children, footer, size = 'md' }) {
  ...
  return (
    <Dialog
      ...
      handler={onClose}
      size={sizeMap[size]}
      className="max-w-3xl w-full mx-2 sm:mx-4 rounded-3xl bg-white backdrop-blur-xl shadow-[0_30px_80px_rgba(15,23,42,0.15)] border border-white/60 overflow-hidden flex flex-col"
      role="dialog"
      aria-modal="true"
